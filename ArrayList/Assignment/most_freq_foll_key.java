...
(ASS.U.QQiiQ.Q - that the target with maximum count is unique.)
 */

import java.util.*;

public class most_freq_foll_key {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Most Frequent Target : " + mostFrequent(nums, key));
    }
}